...
Workbook mode sends directly to the ChatGPT URL you enter, without checking whether a study guide has finished or replacing your link with a saved conversation. Paste your study-guide chat URL to give ChatGPT the existing readings and notes as context. The extension opens that URL in a new tab and sends the workbook prompt; ChatGPT handles the available conversation context.
